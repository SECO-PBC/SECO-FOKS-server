...
const (
	...
	StatusCode_TEAM_VO_BEARER_TOKEN_NOT_FOUND_ERROR    StatusCode = 7016
	...
	StatusCode_KV_WRITE_QUEUED                         StatusCode = 8021
	StatusCode_KV_OUTBOX_FULL                          StatusCode = 8022
	StatusCode_GIT_GENERIC_ERROR                       StatusCode = 9001
	StatusCode_GIT_BAD_PATH_ERROR                      StatusCode = 9002
	StatusCode_GIT_BAD_HEAD_ERROR                      StatusCode = 9003
	StatusCode_GIT_BAD_REF_NAME_ERROR                  StatusCode = 9004
	StatusCode_GIT_DANGLING_REF_ERROR                  StatusCode = 9005
	StatusCode_HTTP_ERROR                              StatusCode = 10001
	StatusCode_STRIPE_SESSION_EXISTS_ERROR             StatusCode = 11001
	StatusCode_RT_GENERIC_ERROR                        StatusCode = 12001
	StatusCode_RT_CHANNEL_EXISTS_ERROR                 StatusCode = 12002
	StatusCode_RT_RACE                                 StatusCode = 12003
	StatusCode_RT_AMBIGUOUS_CHANNEL_ERROR              StatusCode = 12004
	...
	StatusCode_RT_CHANNEL_ARCHIVED_ERROR               StatusCode = 12008
	StatusCode_SOCIAL_INVITE_NOT_FOUND_ERROR           StatusCode = 13001
	StatusCode_SOCIAL_INVITE_WRONG_STATE_ERROR         StatusCode = 13002
	StatusCode_SOCIAL_INVITE_STALE_TURN_ERROR          StatusCode = 13003
)
...
var StatusCodeMap = map[string]StatusCode{
	...
	"TEAM_VO_BEARER_TOKEN_NOT_FOUND_ERROR":    7016,
	...
	"KV_WRITE_QUEUED":                         8021,
	"KV_OUTBOX_FULL":                          8022,
	"GIT_GENERIC_ERROR":                       9001,
	"GIT_BAD_PATH_ERROR":                      9002,
	"GIT_BAD_HEAD_ERROR":                      9003,
	"GIT_BAD_REF_NAME_ERROR":                  9004,
	"GIT_DANGLING_REF_ERROR":                  9005,
	"HTTP_ERROR":                              10001,
	"STRIPE_SESSION_EXISTS_ERROR":             11001,
	"RT_GENERIC_ERROR":                        12001,
	"RT_CHANNEL_EXISTS_ERROR":                 12002,
	"RT_RACE":                                 12003,
	"RT_AMBIGUOUS_CHANNEL_ERROR":              12004,
	"RT_NOT_FOUND_ERROR":                      12005,
	"RT_MSG_ORDER_ERROR":                      12006,
	"RT_MSG_REPLAY_MISMATCH":                  12007,
	"RT_CHANNEL_ARCHIVED_ERROR":               12008,
	"SOCIAL_INVITE_NOT_FOUND_ERROR":           13001,
	"SOCIAL_INVITE_WRONG_STATE_ERROR":         13002,
	"SOCIAL_INVITE_STALE_TURN_ERROR":          13003,
}
var StatusCodeRevMap = map[StatusCode]string{
	...
	7016:  "TEAM_VO_BEARER_TOKEN_NOT_FOUND_ERROR",
	...
	8021:  "KV_WRITE_QUEUED",
	8022:  "KV_OUTBOX_FULL",
	9001:  "GIT_GENERIC_ERROR",
	9002:  "GIT_BAD_PATH_ERROR",
	9003:  "GIT_BAD_HEAD_ERROR",
	9004:  "GIT_BAD_REF_NAME_ERROR",
	9005:  "GIT_DANGLING_REF_ERROR",
	10001: "HTTP_ERROR",
	11001: "STRIPE_SESSION_EXISTS_ERROR",
	12001: "RT_GENERIC_ERROR",
	12002: "RT_CHANNEL_EXISTS_ERROR",
	12003: "RT_RACE",
	12004: "RT_AMBIGUOUS_CHANNEL_ERROR",
	12005: "RT_NOT_FOUND_ERROR",
	12006: "RT_MSG_ORDER_ERROR",
	12007: "RT_MSG_REPLAY_MISMATCH",
	12008: "RT_CHANNEL_ARCHIVED_ERROR",
	13001: "SOCIAL_INVITE_NOT_FOUND_ERROR",
	13002: "SOCIAL_INVITE_WRONG_STATE_ERROR",
	13003: "SOCIAL_INVITE_STALE_TURN_ERROR",
}
...
type Status struct {
	...
	F_23__ *KVNodeID             `json:"f23,omitempty"`
...
func (s Status) GetSc() (ret StatusCode, err error) {
	...
	case StatusCode_KV_WRITE_QUEUED:
		if s.F_23__ == nil {
...
func (s Status) GitBadHeadError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_GIT_BAD_HEAD_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when GitBadHeadError is called", s.Sc))
	}
	return *s.F_1__
}
func (s Status) GitBadRefNameError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_GIT_BAD_REF_NAME_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when GitBadRefNameError is called", s.Sc))
	}
	return *s.F_1__
}
...
func (s Status) RtGenericError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_RT_GENERIC_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when RtGenericError is called", s.Sc))
	}
	return *s.F_1__
}
func (s Status) RtRace() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_RT_RACE {
		panic(fmt.Sprintf("unexpected switch value (%v) when RtRace is called", s.Sc))
	}
	return *s.F_1__
}
func (s Status) RtAmbiguousChannelError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_RT_AMBIGUOUS_CHANNEL_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when RtAmbiguousChannelError is called", s.Sc))
	}
	return *s.F_1__
}
func (s Status) RtNotFoundError() string {
	if s.F_1__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_RT_NOT_FOUND_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when RtNotFoundError is called", s.Sc))
	}
	return *s.F_1__
}
...
func (s Status) RtMsgOrderError() string {
	...
	if s.Sc != StatusCode_RT_MSG_ORDER_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when RtMsgOrderError is called", s.Sc))
	}
	return *s.F_1__
}
...
func (s Status) GitDanglingRefError() bool {
	if s.F_22__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_GIT_DANGLING_REF_ERROR {
		panic(fmt.Sprintf("unexpected switch value (%v) when GitDanglingRefError is called", s.Sc))
	}
	return *s.F_22__
}
func (s Status) KvWriteQueued() KVNodeID {
	if s.F_23__ == nil {
		panic("unexpected nil case; should have been checked")
	}
	if s.Sc != StatusCode_KV_WRITE_QUEUED {
		panic(fmt.Sprintf("unexpected switch value (%v) when KvWriteQueued is called", s.Sc))
	}
	return *s.F_23__
}
...
func NewStatusWithRtChannelExistsError() Status {
	return Status{
		Sc: StatusCode_RT_CHANNEL_EXISTS_ERROR,
	}
}
func NewStatusWithRtChannelArchivedError() Status {
	return Status{
		Sc: StatusCode_RT_CHANNEL_ARCHIVED_ERROR,
	}
}
func NewStatusWithTeamVoBearerTokenNotFoundError() Status {
	return Status{
		Sc: StatusCode_TEAM_VO_BEARER_TOKEN_NOT_FOUND_ERROR,
	}
}
func NewStatusWithKvOutboxFull() Status {
	return Status{
		Sc: StatusCode_KV_OUTBOX_FULL,
	}
}
...
func NewStatusWithSocialInviteNotFoundError() Status {
	return Status{
		Sc: StatusCode_SOCIAL_INVITE_NOT_FOUND_ERROR,
	}
}
func NewStatusWithSocialInviteWrongStateError() Status {
	return Status{
		Sc: StatusCode_SOCIAL_INVITE_WRONG_STATE_ERROR,
	}
}
func NewStatusWithSocialInviteStaleTurnError() Status {
	return Status{
		Sc: StatusCode_SOCIAL_INVITE_STALE_TURN_ERROR,
	}
}
...
func NewStatusWithGitBadHeadError(v string) Status {
	return Status{
		Sc:    StatusCode_GIT_BAD_HEAD_ERROR,
		F_1__: &v,
	}
}
...
func NewStatusWithRtGenericError(v string) Status {
	return Status{
		Sc:    StatusCode_RT_GENERIC_ERROR,
		F_1__: &v,
	}
}
func NewStatusWithRtRace(v string) Status {
	return Status{
		Sc:    StatusCode_RT_RACE,
		F_1__: &v,
	}
}
func NewStatusWithRtAmbiguousChannelError(v string) Status {
	return Status{
		Sc:    StatusCode_RT_AMBIGUOUS_CHANNEL_ERROR,
		F_1__: &v,
	}
}
...
func NewStatusWithRtMsgOrderError(v string) Status {
	return Status{
		Sc:    StatusCode_RT_MSG_ORDER_ERROR,
		F_1__: &v,
	}
}
...
func NewStatusWithGitDanglingRefError(v bool) Status {
	return Status{
		Sc:     StatusCode_GIT_DANGLING_REF_ERROR,
		F_22__: &v,
	}
}
func NewStatusWithKvWriteQueued(v KVNodeID) Status {
	return Status{
		Sc:     StatusCode_KV_WRITE_QUEUED,
		F_23__: &v,
	}
}
...
func (s StatusInternal__) Import() Status {
	return Status{
		...
		F_23__: (func(x *KVNodeIDInternal__) *KVNodeID {
			if x == nil {
				return nil
			}
			tmp := (func(x *KVNodeIDInternal__) (ret KVNodeID) {
				if x == nil {
					return ret
				}
				return x.Import()
...
func (s Status) Export() *StatusInternal__ {
	return &StatusInternal__{
		...
		Switch__: StatusInternalSwitch__{
			...
			F_21__: s.F_21__,
			F_22__: s.F_22__,
			F_23__: (func(x *KVNodeID) *KVNodeIDInternal__ {
				if x == nil {
					return nil
				}
				return (*x).Export()
